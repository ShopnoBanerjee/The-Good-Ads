...
const Wwd: React.FC = () => {
  return (
    <section className="relative min-h-screen">
      ...
      {/* Component content */}
      <div className="relative z-10 bg-[#1679A8] bg-opacity-80 text-white py-8 sm:py-12 md:py-16 lg:py-20 pb-40 sm:pb-60 md:pb-80 lg:pb-72 xl:pb-80 px-4 sm:px-6 md:px-8 lg:px-12">
      ...
      <img
        ...
        className="absolute bottom-0 left-1/2 -translate-x-1/2 z-50 w-full max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-2xl xl:max-w-4xl h-auto pointer-events-none lg:-translate-y-16 xl:-translate-y-0"
      />
    </section>
  );
};
