...
export default function BusinessDashboard() {
  ...
  const getStatusBadge = (status) => {
    ...
    return <Badge className={`${variants[status] || variants.draft} capitalize font-medium`}>{status || "draft"}</Badge>
  }
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between space-y-6 lg:space-y-0">
            ...
            <Button asChild className="btn-primary bg-white text-accent hover:bg-white/90 px-8 py-3 h-auto">
              <Link href="/dashboard/business/add-project" className="flex items-center space-x-2">
          ...
          <div className="flex items-center justify-between">
            ...
            {projects.length > 0 && (
              <Button asChild className="btn-secondary">
                <Link href="/dashboard/business/add-project">
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              {projects.map((project) => (
                <Card key={project.id} className="group card rounded-2xl hover:shadow-lg transition-all duration-200">
                  <CardHeader className="pb-4">
                    <div className="flex items-start justify-between">
                      <div className="space-y-2 flex-1">
                        ...
                        <p className="text-text-muted leading-relaxed line-clamp-2">{project.compliant_description}</p>
                      </div>
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-4 sm:space-y-0">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <Button
                          ...
                          onClick={() => router.push(`/dashboard/business/edit-project/${project.id}`)}
                        >
